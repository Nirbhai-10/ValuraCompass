...
| **Tax**         | India FY 2024-25 calculator with proper Old vs New regime bifurcation. Income inputs (salary, business, house property, other), HRA / LTA carve-outs, Chapter VI-A deductions (80C, 80CCD(1B), 80D, 24(b), 80E, 80G, 80TTA), 80CCD(2) for both regimes, Section 87A rebate, surcharge tiers, and the 4% Health & Education cess. Side-by-side comparison cards, slab visualizer for both regimes, and a "why this regime" rationale. Auto-fill from the household's income / liabilities / health-insurance data with one click. |
